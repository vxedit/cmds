...
sur_names=[
	    ...
	    "adorable", "adventurous", "ambitious", "anxious", "calm", "cheerful", "courageous", 
        "curious", "enthusiastic", "gentle", "generous", "happy", "honest", "humble", 
        "joyful", "loyal", "mysterious", "playful", "respectful", "shy", "smart", 
        "sociable", "thoughtful", "warm", "wise"
...
for i in range(100):
    first_word = random.choice(sur_names)
    second_word = random.choice(first_names)

    # Generate the final word
    generated_word = f"{first_word}-{second_word}"
    nameli+=[generated_word]
